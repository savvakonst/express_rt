...
Module_C04_::Module_C04_(const void* ptr, size_t size, ExtensionManager* manager) : Module_C04_() {
    if (size != getTaskSize()) {
...
const DataSchema_ifs* Module_C04_::getPropertySchema() const { return nullptr; }

const HierarchicalData_ifs* Module_C04_::getProperty(const std::string& prop_path) const {
...
bool Module_C04_::setProperty(const std::string& prop_path, const Value& value) {

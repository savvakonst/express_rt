...
Module_D02_::Module_D02_(const void* ptr, size_t size, ExtensionManager* manager) : Module_D02_() {
    if (size != getTaskSize()) {
...
const DataSchema_ifs* Module_D02_::getPropertySchema() const { return nullptr; }

const HierarchicalData_ifs* Module_D02_::getProperty(const std::string& prop_path) const {
...
bool Module_D02_::setProperty(const std::string& prop_path, const Value& value) {

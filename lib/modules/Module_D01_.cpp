...
Module_D01_::Module_D01_(const void* ptr, size_t size, ExtensionManager* context) : Module_D01_() {
    if (size != getTaskSize()) {
...
const DataSchema_ifs* Module_D01_::getPropertySchema() const { return nullptr; }
...
bool Module_D01_::setProperty(const std::string& prop_path, const Value& value) {

...
Module_A03_::Module_A03_(const void* ptr, size_t size, ExtensionManager* context) : Module_A03_() {
    if (size != getTaskSize()) {
...
const DataSchema_ifs* Module_A03_::getPropertySchema() const { return nullptr; }
